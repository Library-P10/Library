...
public interface CopyRepository extends JpaRepository<Copy, Long> {
    ...
    // Update status en attente de récupération
    @Transactional
    @Modifying
    @Query("UPDATE Copy c SET c.status = 'En attente de récupération' WHERE c.id = :idCopy")
    void updateStatusWaitingGetCustomer(@Param("idCopy")Long idCopy);
